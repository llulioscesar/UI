...
var button = function (props) {
    ...
    return (react_1.default.createElement("button", { className: props.className, onClick: function (event) { return click(event); }, style: props.style }, props.text || props.children));
};
